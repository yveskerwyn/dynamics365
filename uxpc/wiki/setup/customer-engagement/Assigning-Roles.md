...
![image.png](images/assign-roles-ppac-environments.png)

Click **+New** to add a new environment:

![image.png](images/assign-roles-ppac-new-environment.png)

Give your new environment a name, e.g. **CE Trail**, then select **Trial (Subscription-based)** as type, and click **Next**:

![image.png](images/assign-roles-ppac-new-environment-name.png)

Specify a **URL** for your new environment, choose **Yes** for the option to **Enable Dynamics 365 apps**:

![image.png](images/assign-roles-ppac-new-environment-enable-dynamics-365-apps.png)
...
![image.png](images/assign-roles-ppac-new-environment-all-enterpise-apps.png)

As result your new environment will get prepared:

![image.png](images/assign-roles-ppac-new-environment-getting-prepared.png)

After a while you can click **Refresh** which will show that your new trial environment got successfully created:

![image.png](images/assign-roles-ppac-new-environment-successfully-created.png)

> Trying to add a database to the default environment and enabling the Dynamics 365 apps is not supported.

> You will get this: 

> ![image.png](images/assign-roles-ppac-adding-database-to-default-environment-not-supported.png)
...
> ![image.png](images/assign-roles-ppac-created-new-production-environment-not-supported.png)

## Make sure all your users are listed

Click the newly created environment will bring you to following screen:

![image.png](images/assign-roles-ppac-new-environment-details.png)

Click **Settings**:

![image.png](images/assign-roles-ppac-new-environment-settings.png)

Expand the section **Users + permissions** and click **Users**:

![image.png](images/assign-roles-ppac-new-environment-users.png)
...
![image.png](images/assign-roles-ppac-new-environment-add-user.png)

Specify the user you want to add:

![image.png](images/assign-roles-ppac-new-environment-select-user.png)

Click **Add**:

![image.png](images/assign-roles-ppac-new-environment-add-selected-user.png)

Next you are invited to assign a security role:

![image.png](images/assign-roles-ppac-new-environment-new-user-assign-security-role.png)
...
![image.png](images/assign-roles-advanced-settings-dutch.png)
...
![image.png](images/assign-roles-advanced-settings-dutch-system-administration.png)

Next click on **Languages** (Talen), which will bring up the **Language Settings** (Taalinstellingen) pop-up window:

![image.png](images/assign-roles-advanced-settings-dutch-system-administration-languages.png)

Select **English** (Engels) and then click **Apply** (Toepassen):

![image.png](images/assign-roles-advanced-settings-dutch-system-administration-languages-change-to-english.png)

Confirm the change by clicking **OK** on the next pop-up window:

![image.png](images/assign-roles-advanced-settings-dutch-system-administration-languages-change-to-english-confirm.png)
...
![image.png](images/assign-roles-personal-settings-languages.png)
...
![image.png](images/assign-roles-advanced-settings-system-security.png)

Next click **Users**:

![image.png](images/assign-roles-advanced-settings-system-security-users.png)

Here select the **Full Access Users** view:

![image.png](images/assign-roles-advanced-settings-system-security-users-full-access-users-view.png)

Select all users and then click **Manage Roles** in the menu:

![image.png](images/assign-roles-advanced-settings-system-security-users-manage-roles.png)

This will bring up the **Manage User Roles** dialog window:

![image.png](images/assign-roles-ppac-new-environment-new-user-manage-user-roles.png)
...
![image.png](images/assign-roles-dynamics-365-home.png)

Scroll down  and pin the **Sales Hub** app:

![image.png](images/assign-roles-dynamics-365-home-pin-sales-hub.png)

Scroll up again and click the **Sales Hub** app that you just pinned:

![image.png](images/assign-roles-dynamics-365-home-select-pinned-sales-hub.png)

## Access you first Dynamics 365 app through the legacy Dynamics 365 Home page

Go to https://portal.office.com, click **All Apps** icon, and then click the **Business Apps** tab:

![image.png](images/assign-roles-business-apps.png)
...
![dynamics-365-my-apps](images/dynamics-365-my-apps.png)
...
![dynamics-365-my-apps-manage-roles](images/dynamics-365-my-apps-manage-roles.png)

Here for instance you see all security roles that give access to the **Field Service** app:

![dynamics-365-my-apps-manage-roles-field-service](images/dynamics-365-my-apps-manage-roles-field-service.png)
...
![dynamics-365-advanced-settings-apps](images/dynamics-365-advanced-settings-apps.png)

![dynamics-365-advanced-settings-apps-published-apps](images/dynamics-365-advanced-settings-apps-published-apps.png)
